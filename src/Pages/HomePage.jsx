    ...
    <div className="">
       {/* herosection */}
        ...
        {/* <video
          ...
          <div className='flex lg:gap-x-6 lg:px-8 lg:w-fit mt-6 '>

          <div className=' mb-10 lg:w-fit w-full flex justify-center '>
          <img src={boyOnline} width={250}  className=' lg:rounded-full rounded-lg lg:h-full h-full object-cover shadow-lg '/>
          </div>
        ...
        {/* heading */}
        <div className='flex flex-col justify-center items-center gap-y-1 mb-7 mt-7'>    
       
        <h1 className=' text-4xl text-center font-Inter font-semibold '>School ERP Management Software</h1>
        <p className=' text-lg font-inter md:w-full text-center text-richblack-800'>Most Affordable Self-Hosted School Management System Software. There is No Monthly/Yearly Charges</p>
        </div>
        ...
        <div className=' bg-white flex items-center justify-center flex-col gap-y-12 py-7'>
          <h1 className=' lg:text-4xl text-3xl font-inter mt-4 font-semibold'>Eerything You Need to Manage Your School</h1>
        ...
        <h1 className=' text-4xl leading-8 font-inter text-richblack-700 font-semibold'> We Are Fully Dedicated To Support</h1>
